                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <ul class="list-group" style="width: 100%">
                                    ...
                                    @if (!$current_guestdata_ceremony->isEmpty() || $current_guestdata_ceremony->count() > $allguestQuery->count() )
                                            ...
                                            @if (isset($current_guestdata_ceremony[$loop->index]) && collect($current_guestdata_ceremony[$loop->index])->isNotEmpty())
                                            <div class="row">
                                                <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">


                                                            <h6>{{ $guest->g_first_name }} {{ $guest->g_last_name }}</h6>

                                                            <input type="hidden" name="record_id" value="{{ $current_guestdata_ceremony[$loop->index]->id }}">
                                                        ...
                                                        <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12 d-flex w-100 justify-content-between align-content-center align-items-center">
                                                            <div class="mb-3" style="min-width: 100%;"><button class="btn btn-sm btn-primary d-block w-100" type="submit">Save</button></div>
                                                        </form>
                                                        </div>
                                                    </div>
                                            @else
                                            <div class="row">
                                                    <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">
                                                            ...
                                                            <div class="col-lg-7 col-sm-12 col-xs-12 col-md-12 checkboxes d-flex w-100 justify-content-between align-content-center align-items-center">
                                                                ...
                                                                <label class="radio">
                                                                    <input name="attendance_status.{{ $ceremony }}.{{ $loop->index }}" type="radio" value="Pending" checked/>
                                                                    <span>Pending</span>
                                                                </label>

                                                                <label class="radio">
                                                                    <input name="attendance_status.{{ $ceremony }}.{{ $loop->index }}" type="radio" value="Accept" />
                                                                    <span>I Accept</span>
                                                                </label>

                                                                <label class="radio">
                                                                    <input name="attendance_status.{{ $ceremony }}.{{ $loop->index }}" type="radio" value="Reject" />
                                                                    <span>I Don't Accept</span>
                                                                </label>

                                                                <label class="radio">
                                                                    <input name="c_is_drink" type="checkbox" />
                                                                    <span>Have Drinks?</span>
                                                                </label>
                                    ...
                                    @if (!$current_guestdata_evening_reception->isEmpty() || $current_guestdata_evening_reception->count() > $allguestQuery->count())
                                    <li class="list-group-item">
                                        ...
                                        @if (isset($current_guestdata_evening_reception[$loop->index]) && collect($current_guestdata_evening_reception[$loop->index])->isNotEmpty())
                                                <div class="row">
                                                    <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">


                                                                <h6>{{ $guest->g_first_name }} {{ $guest->g_last_name }}</h6>
                                                                <input type="hidden" name="record_id" value="{{ $current_guestdata_evening_reception[$loop->index]->id }}">
                                                                <input type="hidden" name="c_id" value="{{ $guest->c_id }}">
                                                                <input type="hidden" name="guest_id" value="{{ $guest->id }}">
                                                                <input type="hidden" name="companion_id" value="{{ $guest->guest_id }}">
                                                                <input type="hidden" name="event" value="{{ $eveningreception }}">
                                                                <input type="hidden" name="loopindex" value="{{ $loop->index }}">
                                                        ...
                                                        @else
                                                                ...
                                                                <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">
                                                                    ...
                                                                    <div class="col-lg-7 col-sm-12 col-xs-12 col-md-12 checkboxes d-flex w-100 justify-content-between align-content-center align-items-center">
                                                                        ...
                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $eveningreception }}.{{ $loop->index }}" type="radio" value="Pending" checked/>
                                                                            <span>Pending</span>
                                                                        </label>

                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $eveningreception }}.{{ $loop->index }}" type="radio" value="Accept" />
                                                                            <span>I Accept</span>
                                                                        </label>

                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $eveningreception }}.{{ $loop->index }}" type="radio" value="Reject" />
                                                                            <span>I Don't Accept</span>
                                                                        </label>
                                    ...
                                    @if (!$current_guestdata_wedding_breakfast->isEmpty() || $current_guestdata_wedding_breakfast->count() > $allguestQuery->count())
                                            <li class="list-group-item">
                                                @php
                                                ...
                                                @if (isset($current_guestdata_wedding_breakfast[$loop->index]) && collect($current_guestdata_wedding_breakfast[$loop->index])->isNotEmpty())
                                                        <div class="row">
                                                            <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">


                                                                        <h6>{{ $guest->g_first_name }} {{ $guest->g_last_name }}</h6>
                                                                        <input type="hidden" name="record_id" value="{{ $current_guestdata_wedding_breakfast[$loop->index]->id }}">
                                                                        <input type="hidden" name="c_id" value="{{ $guest->c_id }}">
                                                                        <input type="hidden" name="guest_id" value="{{ $guest->id }}">
                                                                        <input type="hidden" name="companion_id" value="{{ $guest->guest_id }}">
                                                                        <input type="hidden" name="event" value="{{ $breakfast }}">
                                                                        <input type="hidden" name="loopindex" value="{{ $loop->index }}">
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">
                                                                ...
                                                                <div class="col-lg-7 col-sm-12 col-xs-12 col-md-12 checkboxes d-flex w-100 justify-content-between align-content-center align-items-center">
                                                                    ...
                                                                    <label class="radio">
                                                                        <input name="attendance_status.{{ $breakfast }}.{{ $loop->index }}" type="radio" value="Pending" checked/>
                                                                        <span>Pending</span>
                                                                    </label>

                                                                    <label class="radio">
                                                                        <input name="attendance_status.{{ $breakfast }}.{{ $loop->index }}" type="radio" value="Accept" />
                                                                        <span>I Accept</span>
                                                                    </label>

                                                                    <label class="radio">
                                                                        <input name="attendance_status.{{ $breakfast }}.{{ $loop->index }}" type="radio" value="Reject" />
                                                                        <span>I Don't Accept</span>
                                                                    </label>
                                    ...
                                    @if (!$current_guestdata_other->isEmpty() || $current_guestdata_other->count() > $allguestQuery->count())
                                            <li class="list-group-item">
                                                ...
                                                @if (isset($current_guestdata_other[$loop->index]) && collect($current_guestdata_other[$loop->index])->isNotEmpty())
                                                    <div class="row">
                                                        <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">

                                                                    <h6>{{ $guest->g_first_name }} {{ $guest->g_last_name }}</h6>
                                                                    <input type="hidden" name="record_id" value="{{ $current_guestdata_other[$loop->index]->id }}">
                                                                    <input type="hidden" name="c_id" value="{{ $guest->c_id }}">
                                                                    <input type="hidden" name="guest_id" value="{{ $guest->id }}">
                                                                    <input type="hidden" name="companion_id" value="{{ $guest->guest_id }}">
                                                                    <input type="hidden" name="event" value="{{ $other }}">
                                                                    <input type="hidden" name="loopindex" value="{{ $loop->index }}">
                                                        ...
                                                        @else
                                                                ...
                                                                <div class="col-lg-3 col-xl-3 col-sm-10 col-xs-12 col-md-10 content mb-3 menu-left">
                                                                    ...
                                                                    <div class="col-lg-7 col-sm-12 col-xs-12 col-md-12 checkboxes d-flex w-100 justify-content-between align-content-center align-items-center">
                                                                        ...
                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $other }}.{{ $loop->index }}" type="radio" value="Pending" checked/>
                                                                            <span>Pending</span>
                                                                        </label>

                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $other }}.{{ $loop->index }}" type="radio" value="Accept" />
                                                                            <span>I Accept</span>
                                                                        </label>

                                                                        <label class="radio">
                                                                            <input name="attendance_status.{{ $other }}.{{ $loop->index }}" type="radio" value="Reject" />
                                                                            <span>I Don't Accept</span>
                                                                        </label>
