      ...
      <a href="{{ url('/') }}"><img src="{{ asset('images/logo/WB_logo_1.svg') }}" alt="logo" class="logo"></a>
        ...
        <ul>
            ...
            <li>
                ...
                <li style="padding-top: -7px !important; margin-top: -7px !important;">
                    <label for="btn-22" class="shows" style="padding-top: 0px; padding-bottom: 0px; line-height:0px">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())

                        <img class=""
                        style="width: 25px; max-height:25px;" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" loading="lazy" />

                @else
                <span class="bg-light text-secondary border border-danger">{{ $initials }}</span>
                ...
                @endif
                    ...
                    <!-- large screen avater -->
                    <a style="line-height: 0px; padding-top: 0px; padding-bottom: 0px; margin-top:0px; box-shadow:none !important; border: 0px;">
                    @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())

                        <img class="" style="width: 25px; max-height:25px;" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" loading="lazy" />
                  ...
                  <!-- end large screen avater -->
                    ...
                    <ul class="u_avatar">
                      <li class="itemhidden">
                        ...
                        <a href="#" style="box-shadow:none !important; border: 0px;">
                        <span>
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())

                            <img class="rounded-circle ms-3"
                            max-height="40px" width="40px" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" loading="lazy" />
                        ...
                        <span class="ms-3"> Hi, User {{ Auth::user()->name }}!</span>
                        </a>
