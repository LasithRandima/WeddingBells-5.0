            ...
            @endphp
                <blockquote class="{{ !$loop->last ? 'border-bottom' : '' }}">
                    ...
                    <div class="icontext">
                        ...
                        height="50" src="{{ $item->profile_photo_url }}" alt="{{ $item->name }}" loading="lazy" />



                        @else
                        <div class="bg-light text-secondary border border-danger rounded-circle" style="width: 50px; height:50px; display:flex; justify-content:center; align-items:center; color:black;"><b>{{ $initials }}</b></div>
