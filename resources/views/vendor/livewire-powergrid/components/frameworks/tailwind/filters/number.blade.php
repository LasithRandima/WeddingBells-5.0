        ...
        <div class="@if(!$inline) p-2 @endif">
            ...
            <div @class([
                ...
                <div @class([
                    ...
                    <input
                        wire:model.live.debounce.800ms="filters.number.{{ data_get($number, 'dataField') }}.start"
                ...
                <div @class([
                    ...
                    <input
                        wire:model.live.debounce.800ms="filters.number.{{ data_get($number, 'dataField') }}.end"
