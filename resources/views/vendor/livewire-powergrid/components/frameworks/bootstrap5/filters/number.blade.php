        ...
        <div class="{{ $theme->baseClass }}" style="{{ $theme->baseStyle }}">
            <div>
                <input
                    ...
                    wire:model.live.debounce.800ms="filters.number_start.{{ data_get($number, 'dataField') }}"
            ...
            <div class="mt-1">
                <input
                    ...
                    wire:model.live.debounce.800ms="filters.number_end.{{ data_get($number, 'dataField') }}"
