...
class AdvertisementChart extends ChartWidget
{
    protected static ?string $heading = 'Advertisement Chart';
    ...
    protected function getData(): array
    {
        ...
        $bookings = Advertisement::select('created_at')->get()->groupby(function($bookings) {
