...
final class PowerGuestTableList extends PowerGridComponent
{
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('name_lower', fn (ClientGuestList $model) => strtolower(e($model->name)))
    ...
    /*
    public function actionRules(\{{ modelName }} $row): array
    {
       return [
