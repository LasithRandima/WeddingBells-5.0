...
class WeddingBellsPackages extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Thank You for Subscribing to Wedding Bells Package',
        );
    }
    ...
    {
        return new Content(
            markdown: 'common.paymentmail',
            with:[
                'vendorName' => $this->vendorName,
                'packageName' => $this->packageName,
                'imageCount' => $this->imageCount,
                'adsCount' => $this->adsCount,
                'topAdsCount' => $this->topAdsCount,
